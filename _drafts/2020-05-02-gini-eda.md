...
For these and all situations in between, the Gini coefficient is thus calculated as the area enclosed between the Lorenz curve and the line of perfect equality, marked as \\(A\\) in the figure above, divided by the total triangular area, \\(A + B\\).
