...
The Social Security Administration of the United States [hosts public records][9] of the first names given to babies registered with the SSA for researchers interested in naming trends.  When exploring this dataset for children born in 1950 or later, I discovered that 18 out of the top 20 most popular names were most commonly given to male children -- where were the female names?  It is true that slightly more male babies have been registered with the SSA (53% male vs 47% female), but I was still surprised to see such a larger proportion of male names in the popularity charts.

<img src="{{ site.urlimg }}popular_names.png" alt="Most popular names given to US babies since 1950" width = "600">
