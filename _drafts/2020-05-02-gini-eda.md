...
For the case studies that follow, I will be using a vectorized, `numpy` implementation of this calculation that was developed in Python by [Olivia Guest][8].  
...
So far we have talked about Gini coefficient as it may be applied to monetary situations... but it can be used for much more!
